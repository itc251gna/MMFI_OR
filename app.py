...
WORKFLOW_DEFINITION = [
    ...
    },
    {
        ...
        "title": "Τοποθέτηση παραγγελίας εκτός SUP",
        "description": "Διαδικασία εκτός SUP από το Γραφείο Παραγγελιών.",
    },
    {
        "order": 4,
        "station_code": "surgery_secretariat",
        "title": "Έκδοση Υ.Σ. μέσω Medico προς ΜΕΦ",
        "description": "Έκδοση υπηρεσιακού σημειώματος για αίτημα προμήθειας υλικών μέσω SUP.",
    },
    {
        "order": 5,
        "station_code": "mef",
